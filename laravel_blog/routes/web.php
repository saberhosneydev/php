...
Route::middleware(['auth'])->group(function () {
    Route::prefix('dashboard')->group(function () {
        ...
        Route::post('verifyPhone', [UserController::class, 'verifyPhone'])->name('account.settings.verifyPhone');
        Route::post('verifyVerificationCode', [UserController::class, 'verifyVerificationCode'])->name('account.settings.verifyVerificationCode');
    });
});
